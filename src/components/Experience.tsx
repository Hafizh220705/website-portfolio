  ...
  const experiences = [
    {
      ...
      description: "Executed end-to-end data analytics workflows across 10+ projects on datasets exceeding 100K+ records. Conducted data cleaning, EDA, and statistical hypothesis testing to uncover behavioral patterns and business insights. Built SQL-based analysis workflows and interactive dashboards using Python and Power BI to support data-driven decision making.",
      color: "violet",
    },
    {
      ...
      description: "Developed and maintained internal systems to support organizational operations and workflow optimization initiatives. Resolved 25+ technical issues and delivered 10+ feature enhancements, increasing system stability and improving workflow efficiency by approximately 30%.",
      color: "emerald",
    },
    {
      title: "Data Scientist Intern",
      company: "Pusat Inovasi Pengajaran dan Pembelajaran, Universitas Padjadjaran (On-site, Jatinangor)",
      period: "Sep 2025 — Dec 2025",
      description: "Analyzed 1,000+ EEG signal segments using preprocessing and feature extraction techniques to identify behavioral patterns. Developed and evaluated 5+ machine learning models, including SVM and XGBoost, improving model performance by 15–30% through feature engineering and comparative evaluation.",
      color: "blue",
    },
    {
      title: "Back End Developer Intern",
      company: "ElevatEd Indonesia (Remote)",
      period: "Aug 2025 — Dec 2025",
      description: "Developed and deployed 10+ RESTful APIs using Next.js (App Router) and Supabase to support scalable backend operations. Integrated authentication systems, implemented role-based access control, and optimized API performance by approximately 30% through server-side optimization and query tuning.",
      color: "emerald",
    },
    {
      title: "Laboratory Teaching Assistant",
      company: "Universitas Padjadjaran (On-site, Jatinangor)",
      period: "Feb 2025 — Dec 2025",
      description: "Facilitated laboratory sessions for 100+ students across Database Systems, Web Programming, and Object-Oriented Programming courses. Evaluated 250+ assignments and mentored students in SQL implementation, database integration, and analytical problem-solving.",
      color: "fuchsia",
    },
    {
      ...
      description: "Analyzed 466K+ financial loan records using preprocessing and exploratory data analysis (EDA) to identify borrower risk patterns for credit risk assessment. Evaluated 6 predictive models, including XGBoost and Random Forest, to support financial risk analysis and strategic decision making.",
      color: "violet",
    },
  ];
